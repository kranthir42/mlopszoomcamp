...
def run(model_file, year, month):
    df, y_pred = apply_model(model_file=model_file, data_file=f'https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_{year}-{month}.parquet')
